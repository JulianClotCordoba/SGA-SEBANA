            ...
            <div class="container">
                <div class="header4-wrap">
                    <div class="header__logo">
                        <a href="#">
                            <img src="/SGA-SEBANA/public/assets/img/icon/logo-blue.png" alt="CoolAdmin">
                        </a>
                    </div>
                    <div class="header__tool">
                        ...
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                <div class="image">
                                    <img src="/SGA-SEBANA/public/assets/img/icon/avatar-01.jpg" alt="John Doe">
                                </div>
                                <div class="content">
                                    ...
                                    <ul class="list-unstyled navbar__list">
                                        <li class="active has-sub">
                                            ...
                                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                                <li>
                                                    <a href="/SGA-SEBANA/public/home">Dashboard 1</a>
                                                </li>
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/index2">Dashboard 2</a>
                                                </li>
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/index3">Dashboard 3</a>
                                                </li>
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/index4">Dashboard 4</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li class="has-sub">
                                            ...
                                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/table">Tables</a>
                                                </li>
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/form">Forms</a>
                                                </li>
                                                <li>
                                                    <a href="#">Calendar</a>
                                                </li>
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/map">Maps</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="has-sub">
                                        ...
                                        <li class="has-sub">
                                            ...
                                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                                ...
                                                <li>
                                                    <a href="/SGA-SEBANA/public/ui/fontawesome">FontAwesome</a>
                                                </li>
                                                <li>
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="page-content">
                                            ...
                                            <div class="filters m-b-55">
                                                <div class="select-wrapper">
                                                    <select class="form-select form-select-lg" name="property">
                                                        <option selected>Products Sales</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="au-card au-card--no-shadow au-card--no-pad m-b-40 au-card--border">
                                            <div class="au-card-title" style="background-image:url('/SGA-SEBANA/public/assets/img/bg-title-01.jpg');">
                                                ...
                                                <h3>
                                                    <i class="zmdi zmdi-account-calendar"></i>25 January, 2025</h3>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="au-card au-card--no-shadow au-card--no-pad m-b-40 au-card--border">
                                            <div class="au-card-title" style="background-image:url('/SGA-SEBANA/public/assets/img/bg-title-02.jpg');">
                                                <div class="bg-overlay bg-overlay--blue"></div>
                                                <h3>
                                                        ...
                                                        <div class="au-chat-info">
                                                            <div class="avatar-wrap online">
                                                                <div class="avatar avatar--small">
                                                                    <img src="/SGA-SEBANA/public/assets/img/icon/avatar-02.jpg" alt="John Smith">
                                                                </div>
                                                            </div>
                                                            <span class="nick">
                                                                <a href="#">John Smith</a>
