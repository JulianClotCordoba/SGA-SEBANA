                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <button type="button" class="btn btn-primary">
                                            <i class="fa-solid fa-star"></i>  Primary</button>
                                        <button type="button" class="btn btn-secondary">
                                            <i class="fa-regular fa-lightbulb"></i>  Secondary</button>
                                        <button type="button" class="btn btn-success">
                                            <i class="fa-solid fa-magic"></i>  Success</button>
                                        <button type="button" class="btn btn-warning">
                                            <i class="fa-solid fa-map-marker"></i>  Warning</button>
                                        <button type="button" class="btn btn-danger">
                                            <i class="fa-solid fa-rss"></i>  Danger</button>
