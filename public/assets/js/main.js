...
// Vector Map - Replaced with Leaflet for World Map functionality
ready(() => {
  try {
    const vmapElement = $('#vmap');
    if (vmapElement) {
      vmapElement.style.height = '300px';
      ...
      // Add markers for demo data (e.g., from the table)
      const markers = [
        { coords: [37.0902, -95.7129], country: "United States", value: "$119,366.96" },
        { coords: [-25.2744, 133.7751], country: "Australia", value: "$70,261.65" },
        { coords: [55.3781, -3.4360], country: "United Kingdom", value: "$46,399.22" },
        { coords: [38.9637, 35.2433], country: "Turkey", value: "$35,364.90" },
        { coords: [51.1657, 10.4515], country: "Germany", value: "$20,366.96" },
        { coords: [46.2276, 2.2137], country: "France", value: "$10,366.96" },
        { coords: [41.8719, 12.5674], country: "Italy", value: "$1,639.32" }
      ];

      markers.forEach(marker => {
        L.marker(marker.coords).addTo(map)
          .bindPopup(`<b>${marker.country}</b><br>Revenue: ${marker.value}`);
      });
    }
  } catch (error) {
    console.log(error);
